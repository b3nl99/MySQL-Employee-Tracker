...
const { departmentSelect, departmentPrompt, departmentInsert, getDepartmentCost, departmentDestroyPrompt, departmentDestroyInsert } = require('./Departments');
const { roleSelect, rolePrompt, roleInsert, roleDestroyPrompt, roleDestroyInsert } = require('./Role');
const { employeeByManager, employeeByDepartment, employeePrompt, employeeInsert, employeeUpdatePrompt, employeeUpdateReturn, employeeDestroyPrompt, employeeDestroyInsert } = require('./Employee');
